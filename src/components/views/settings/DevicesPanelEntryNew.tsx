...
import SelectableDeviceNewTile from './devices/SelectableDeviceNewTile';
...
export default class DevicesPanelEntryNew extends React.Component<IProps, IState> {
    ...
    public render(): JSX.Element {
        ...
        return (
            <div className="mx_DevicesPanel_device">
                <SelectableDeviceNewTile device={deviceWithVerification} onClick={this.onDeviceToggled} isSelected={this.props.selected}>
                    { buttons }
                </SelectableDeviceNewTile>
            </div>
        );
    }
}
