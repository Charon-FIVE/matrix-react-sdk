...
const DeviceNewTile: React.FC<DeviceTileProps> = ({ device, children, onClick }) => {
    ...
    return <div className="mx_DeviceNewTile" data-testid={`device-tile-${device.device_id}`}>
        <div className="mx_DeviceTile_info" onClick={null}>
             {device.device_id}
        </div>
        <div className="mx_DeviceTile_displayname">
           {device.display_name}
        </div>
