...
import ReadReceiptMarker, { IReadReceiptInfo } from "../../views/rooms/ReadReceiptMarker";
import { IReadReceiptProps } from "../../views/rooms/EventTile";
...
export function ReadListButton(
