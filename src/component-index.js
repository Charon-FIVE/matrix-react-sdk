...
import structures$BackdropPanel from './components/structures/BackdropPanel';
structures$BackdropPanel && (components['structures.BackdropPanel'] = structures$BackdropPanel);
...
import structures$FileDropTarget from './components/structures/FileDropTarget';
structures$FileDropTarget && (components['structures.FileDropTarget'] = structures$FileDropTarget);
...
import structures$LegacyGroupView from './components/structures/LegacyGroupView';
structures$LegacyGroupView && (components['structures.LegacyGroupView'] = structures$LegacyGroupView);
...
import structures$SpaceHierarchy from './components/structures/SpaceHierarchy';
structures$SpaceHierarchy && (components['structures.SpaceHierarchy'] = structures$SpaceHierarchy);
...
import structures$ThreadPanel from './components/structures/ThreadPanel';
structures$ThreadPanel && (components['structures.ThreadPanel'] = structures$ThreadPanel);
import structures$ThreadView from './components/structures/ThreadView';
structures$ThreadView && (components['structures.ThreadView'] = structures$ThreadView);
...
import views$audio_messages$AudioPlayerBase from './components/views/audio_messages/AudioPlayerBase';
views$audio_messages$AudioPlayerBase && (components['views.audio_messages.AudioPlayerBase'] = views$audio_messages$AudioPlayerBase);
...
import views$auth$EmailField from './components/views/auth/EmailField';
views$auth$EmailField && (components['views.auth.EmailField'] = views$auth$EmailField);
...
import views$auth$PassphraseConfirmField from './components/views/auth/PassphraseConfirmField';
views$auth$PassphraseConfirmField && (components['views.auth.PassphraseConfirmField'] = views$auth$PassphraseConfirmField);
...
import views$beacon$LeftPanelLiveShareWarning from './components/views/beacon/LeftPanelLiveShareWarning';
views$beacon$LeftPanelLiveShareWarning && (components['views.beacon.LeftPanelLiveShareWarning'] = views$beacon$LeftPanelLiveShareWarning);
import views$beacon$RoomLiveShareWarning from './components/views/beacon/RoomLiveShareWarning';
views$beacon$RoomLiveShareWarning && (components['views.beacon.RoomLiveShareWarning'] = views$beacon$RoomLiveShareWarning);
import views$beacon$StyledLiveBeaconIcon from './components/views/beacon/StyledLiveBeaconIcon';
views$beacon$StyledLiveBeaconIcon && (components['views.beacon.StyledLiveBeaconIcon'] = views$beacon$StyledLiveBeaconIcon);
...
import views$context_menus$RoomContextMenu from './components/views/context_menus/RoomContextMenu';
views$context_menus$RoomContextMenu && (components['views.context_menus.RoomContextMenu'] = views$context_menus$RoomContextMenu);
import views$context_menus$SpaceContextMenu from './components/views/context_menus/SpaceContextMenu';
views$context_menus$SpaceContextMenu && (components['views.context_menus.SpaceContextMenu'] = views$context_menus$SpaceContextMenu);
import views$context_menus$ThreadListContextMenu from './components/views/context_menus/ThreadListContextMenu';
views$context_menus$ThreadListContextMenu && (components['views.context_menus.ThreadListContextMenu'] = views$context_menus$ThreadListContextMenu);
...
import views$dialogs$AddExistingSubspaceDialog from './components/views/dialogs/AddExistingSubspaceDialog';
views$dialogs$AddExistingSubspaceDialog && (components['views.dialogs.AddExistingSubspaceDialog'] = views$dialogs$AddExistingSubspaceDialog);
...
import views$dialogs$AnalyticsLearnMoreDialog from './components/views/dialogs/AnalyticsLearnMoreDialog';
views$dialogs$AnalyticsLearnMoreDialog && (components['views.dialogs.AnalyticsLearnMoreDialog'] = views$dialogs$AnalyticsLearnMoreDialog);
...
import views$dialogs$BulkRedactDialog from './components/views/dialogs/BulkRedactDialog';
views$dialogs$BulkRedactDialog && (components['views.dialogs.BulkRedactDialog'] = views$dialogs$BulkRedactDialog);
...
import views$dialogs$ConfirmSpaceUserActionDialog from './components/views/dialogs/ConfirmSpaceUserActionDialog';
views$dialogs$ConfirmSpaceUserActionDialog && (components['views.dialogs.ConfirmSpaceUserActionDialog'] = views$dialogs$ConfirmSpaceUserActionDialog);
...
import views$dialogs$CreateSubspaceDialog from './components/views/dialogs/CreateSubspaceDialog';
views$dialogs$CreateSubspaceDialog && (components['views.dialogs.CreateSubspaceDialog'] = views$dialogs$CreateSubspaceDialog);
...
import views$dialogs$EndPollDialog from './components/views/dialogs/EndPollDialog';
views$dialogs$EndPollDialog && (components['views.dialogs.EndPollDialog'] = views$dialogs$EndPollDialog);
...
import views$dialogs$ExportDialog from './components/views/dialogs/ExportDialog';
views$dialogs$ExportDialog && (components['views.dialogs.ExportDialog'] = views$dialogs$ExportDialog);
...
import views$dialogs$GenericFeatureFeedbackDialog from './components/views/dialogs/GenericFeatureFeedbackDialog';
views$dialogs$GenericFeatureFeedbackDialog && (components['views.dialogs.GenericFeatureFeedbackDialog'] = views$dialogs$GenericFeatureFeedbackDialog);
...
import views$dialogs$LeaveSpaceDialog from './components/views/dialogs/LeaveSpaceDialog';
views$dialogs$LeaveSpaceDialog && (components['views.dialogs.LeaveSpaceDialog'] = views$dialogs$LeaveSpaceDialog);
...
import views$dialogs$ManageRestrictedJoinRuleDialog from './components/views/dialogs/ManageRestrictedJoinRuleDialog';
views$dialogs$ManageRestrictedJoinRuleDialog && (components['views.dialogs.ManageRestrictedJoinRuleDialog'] = views$dialogs$ManageRestrictedJoinRuleDialog);
...
import views$dialogs$ScrollableBaseModal from './components/views/dialogs/ScrollableBaseModal';
views$dialogs$ScrollableBaseModal && (components['views.dialogs.ScrollableBaseModal'] = views$dialogs$ScrollableBaseModal);
...
import views$dialogs$SpacePreferencesDialog from './components/views/dialogs/SpacePreferencesDialog';
views$dialogs$SpacePreferencesDialog && (components['views.dialogs.SpacePreferencesDialog'] = views$dialogs$SpacePreferencesDialog);
...
import views$dialogs$SpotlightDialog from './components/views/dialogs/SpotlightDialog';
views$dialogs$SpotlightDialog && (components['views.dialogs.SpotlightDialog'] = views$dialogs$SpotlightDialog);
...
import views$dialogs$devtools$AccountData from './components/views/dialogs/devtools/AccountData';
views$dialogs$devtools$AccountData && (components['views.dialogs.devtools.AccountData'] = views$dialogs$devtools$AccountData);
import views$dialogs$devtools$BaseTool from './components/views/dialogs/devtools/BaseTool';
views$dialogs$devtools$BaseTool && (components['views.dialogs.devtools.BaseTool'] = views$dialogs$devtools$BaseTool);
import views$dialogs$devtools$Event from './components/views/dialogs/devtools/Event';
views$dialogs$devtools$Event && (components['views.dialogs.devtools.Event'] = views$dialogs$devtools$Event);
import views$dialogs$devtools$FilteredList from './components/views/dialogs/devtools/FilteredList';
views$dialogs$devtools$FilteredList && (components['views.dialogs.devtools.FilteredList'] = views$dialogs$devtools$FilteredList);
import views$dialogs$devtools$RoomState from './components/views/dialogs/devtools/RoomState';
views$dialogs$devtools$RoomState && (components['views.dialogs.devtools.RoomState'] = views$dialogs$devtools$RoomState);
import views$dialogs$devtools$ServerInfo from './components/views/dialogs/devtools/ServerInfo';
views$dialogs$devtools$ServerInfo && (components['views.dialogs.devtools.ServerInfo'] = views$dialogs$devtools$ServerInfo);
import views$dialogs$devtools$ServersInRoom from './components/views/dialogs/devtools/ServersInRoom';
views$dialogs$devtools$ServersInRoom && (components['views.dialogs.devtools.ServersInRoom'] = views$dialogs$devtools$ServersInRoom);
import views$dialogs$devtools$SettingExplorer from './components/views/dialogs/devtools/SettingExplorer';
views$dialogs$devtools$SettingExplorer && (components['views.dialogs.devtools.SettingExplorer'] = views$dialogs$devtools$SettingExplorer);
import views$dialogs$devtools$VerificationExplorer from './components/views/dialogs/devtools/VerificationExplorer';
views$dialogs$devtools$VerificationExplorer && (components['views.dialogs.devtools.VerificationExplorer'] = views$dialogs$devtools$VerificationExplorer);
import views$dialogs$devtools$WidgetExplorer from './components/views/dialogs/devtools/WidgetExplorer';
views$dialogs$devtools$WidgetExplorer && (components['views.dialogs.devtools.WidgetExplorer'] = views$dialogs$devtools$WidgetExplorer);
...
import views$elements$CopyableText from './components/views/elements/CopyableText';
views$elements$CopyableText && (components['views.elements.CopyableText'] = views$elements$CopyableText);
...
import views$elements$GenericEventListSummary from './components/views/elements/GenericEventListSummary';
views$elements$GenericEventListSummary && (components['views.elements.GenericEventListSummary'] = views$elements$GenericEventListSummary);
...
import views$elements$InteractiveTooltip from './components/views/elements/InteractiveTooltip';
views$elements$InteractiveTooltip && (components['views.elements.InteractiveTooltip'] = views$elements$InteractiveTooltip);
...
import views$elements$JoinRuleDropdown from './components/views/elements/JoinRuleDropdown';
views$elements$JoinRuleDropdown && (components['views.elements.JoinRuleDropdown'] = views$elements$JoinRuleDropdown);
...
import views$elements$Measured from './components/views/elements/Measured';
views$elements$Measured && (components['views.elements.Measured'] = views$elements$Measured);
...
import views$elements$NativeOnChangeInput from './components/views/elements/NativeOnChangeInput';
views$elements$NativeOnChangeInput && (components['views.elements.NativeOnChangeInput'] = views$elements$NativeOnChangeInput);
...
import views$elements$PollCreateDialog from './components/views/elements/PollCreateDialog';
views$elements$PollCreateDialog && (components['views.elements.PollCreateDialog'] = views$elements$PollCreateDialog);
...
import views$elements$ReplyChain from './components/views/elements/ReplyChain';
views$elements$ReplyChain && (components['views.elements.ReplyChain'] = views$elements$ReplyChain);
...
import views$elements$TooltipTarget from './components/views/elements/TooltipTarget';
views$elements$TooltipTarget && (components['views.elements.TooltipTarget'] = views$elements$TooltipTarget);
...
import views$location$LiveDurationDropdown from './components/views/location/LiveDurationDropdown';
views$location$LiveDurationDropdown && (components['views.location.LiveDurationDropdown'] = views$location$LiveDurationDropdown);
import views$location$LocationButton from './components/views/location/LocationButton';
views$location$LocationButton && (components['views.location.LocationButton'] = views$location$LocationButton);
import views$location$LocationPicker from './components/views/location/LocationPicker';
views$location$LocationPicker && (components['views.location.LocationPicker'] = views$location$LocationPicker);
import views$location$LocationShareMenu from './components/views/location/LocationShareMenu';
views$location$LocationShareMenu && (components['views.location.LocationShareMenu'] = views$location$LocationShareMenu);
import views$location$LocationViewDialog from './components/views/location/LocationViewDialog';
views$location$LocationViewDialog && (components['views.location.LocationViewDialog'] = views$location$LocationViewDialog);
import views$location$MapError from './components/views/location/MapError';
views$location$MapError && (components['views.location.MapError'] = views$location$MapError);
import views$location$ShareDialogButtons from './components/views/location/ShareDialogButtons';
views$location$ShareDialogButtons && (components['views.location.ShareDialogButtons'] = views$location$ShareDialogButtons);
import views$location$ShareType from './components/views/location/ShareType';
views$location$ShareType && (components['views.location.ShareType'] = views$location$ShareType);
...
import views$messages$DisambiguatedProfile from './components/views/messages/DisambiguatedProfile';
views$messages$DisambiguatedProfile && (components['views.messages.DisambiguatedProfile'] = views$messages$DisambiguatedProfile);
...
import views$messages$HiddenBody from './components/views/messages/HiddenBody';
views$messages$HiddenBody && (components['views.messages.HiddenBody'] = views$messages$HiddenBody);
import views$messages$JumpToDatePicker from './components/views/messages/JumpToDatePicker';
views$messages$JumpToDatePicker && (components['views.messages.JumpToDatePicker'] = views$messages$JumpToDatePicker);
...
views$messages$MLocationBody && (components['views.messages.MLocationBody'] = views$messages$MLocationBody);
import views$messages$MPollBody from './components/views/messages/MPollBody';
views$messages$MPollBody && (components['views.messages.MPollBody'] = views$messages$MPollBody);
...
import views$right_panel$TimelineCard from './components/views/right_panel/TimelineCard';
views$right_panel$TimelineCard && (components['views.right_panel.TimelineCard'] = views$right_panel$TimelineCard);
...
import views$rooms$CollapsibleButton from './components/views/rooms/CollapsibleButton';
views$rooms$CollapsibleButton && (components['views.rooms.CollapsibleButton'] = views$rooms$CollapsibleButton);
...
import views$rooms$HistoryTile from './components/views/rooms/HistoryTile';
views$rooms$HistoryTile && (components['views.rooms.HistoryTile'] = views$rooms$HistoryTile);
...
import views$rooms$MessageComposerButtons from './components/views/rooms/MessageComposerButtons';
views$rooms$MessageComposerButtons && (components['views.rooms.MessageComposerButtons'] = views$rooms$MessageComposerButtons);
...
import views$rooms$RecentlyViewedButton from './components/views/rooms/RecentlyViewedButton';
views$rooms$RecentlyViewedButton && (components['views.rooms.RecentlyViewedButton'] = views$rooms$RecentlyViewedButton);
...
import views$rooms$RoomListHeader from './components/views/rooms/RoomListHeader';
views$rooms$RoomListHeader && (components['views.rooms.RoomListHeader'] = views$rooms$RoomListHeader);
...
import views$rooms$ThreadSummary from './components/views/rooms/ThreadSummary';
views$rooms$ThreadSummary && (components['views.rooms.ThreadSummary'] = views$rooms$ThreadSummary);
...
import views$settings$CryptographyPanel from './components/views/settings/CryptographyPanel';
views$settings$CryptographyPanel && (components['views.settings.CryptographyPanel'] = views$settings$CryptographyPanel);
...
import views$settings$FontScalingPanel from './components/views/settings/FontScalingPanel';
views$settings$FontScalingPanel && (components['views.settings.FontScalingPanel'] = views$settings$FontScalingPanel);
import views$settings$ImageSizePanel from './components/views/settings/ImageSizePanel';
views$settings$ImageSizePanel && (components['views.settings.ImageSizePanel'] = views$settings$ImageSizePanel);
...
import views$settings$JoinRuleSettings from './components/views/settings/JoinRuleSettings';
views$settings$JoinRuleSettings && (components['views.settings.JoinRuleSettings'] = views$settings$JoinRuleSettings);
import views$settings$KeyboardShortcut from './components/views/settings/KeyboardShortcut';
views$settings$KeyboardShortcut && (components['views.settings.KeyboardShortcut'] = views$settings$KeyboardShortcut);
import views$settings$LayoutSwitcher from './components/views/settings/LayoutSwitcher';
views$settings$LayoutSwitcher && (components['views.settings.LayoutSwitcher'] = views$settings$LayoutSwitcher);
...
import views$settings$SettingsFieldset from './components/views/settings/SettingsFieldset';
views$settings$SettingsFieldset && (components['views.settings.SettingsFieldset'] = views$settings$SettingsFieldset);
...
import views$settings$ThemeChoicePanel from './components/views/settings/ThemeChoicePanel';
views$settings$ThemeChoicePanel && (components['views.settings.ThemeChoicePanel'] = views$settings$ThemeChoicePanel);
import views$settings$UiFeatureSettingWrapper from './components/views/settings/UiFeatureSettingWrapper';
views$settings$UiFeatureSettingWrapper && (components['views.settings.UiFeatureSettingWrapper'] = views$settings$UiFeatureSettingWrapper);
...
import views$settings$tabs$user$KeyboardUserSettingsTab from './components/views/settings/tabs/user/KeyboardUserSettingsTab';
views$settings$tabs$user$KeyboardUserSettingsTab && (components['views.settings.tabs.user.KeyboardUserSettingsTab'] = views$settings$tabs$user$KeyboardUserSettingsTab);
...
import views$settings$tabs$user$SidebarUserSettingsTab from './components/views/settings/tabs/user/SidebarUserSettingsTab';
views$settings$tabs$user$SidebarUserSettingsTab && (components['views.settings.tabs.user.SidebarUserSettingsTab'] = views$settings$tabs$user$SidebarUserSettingsTab);
...
import views$spaces$QuickSettingsButton from './components/views/spaces/QuickSettingsButton';
views$spaces$QuickSettingsButton && (components['views.spaces.QuickSettingsButton'] = views$spaces$QuickSettingsButton);
import views$spaces$QuickThemeSwitcher from './components/views/spaces/QuickThemeSwitcher';
views$spaces$QuickThemeSwitcher && (components['views.spaces.QuickThemeSwitcher'] = views$spaces$QuickThemeSwitcher);
...
import views$spaces$SpaceChildrenPicker from './components/views/spaces/SpaceChildrenPicker';
views$spaces$SpaceChildrenPicker && (components['views.spaces.SpaceChildrenPicker'] = views$spaces$SpaceChildrenPicker);
...
import views$typography$Heading from './components/views/typography/Heading';
views$typography$Heading && (components['views.typography.Heading'] = views$typography$Heading);
...
import views$voip$CallView$CallViewButtons from './components/views/voip/CallView/CallViewButtons';
views$voip$CallView$CallViewButtons && (components['views.voip.CallView.CallViewButtons'] = views$voip$CallView$CallViewButtons);
import views$voip$CallView$CallViewHeader from './components/views/voip/CallView/CallViewHeader';
views$voip$CallView$CallViewHeader && (components['views.voip.CallView.CallViewHeader'] = views$voip$CallView$CallViewHeader);
...
import views$voip$CallViewSidebar from './components/views/voip/CallViewSidebar';
views$voip$CallViewSidebar && (components['views.voip.CallViewSidebar'] = views$voip$CallViewSidebar);
...
import views$voip$PictureInPictureDragger from './components/views/voip/PictureInPictureDragger';
views$voip$PictureInPictureDragger && (components['views.voip.PictureInPictureDragger'] = views$voip$PictureInPictureDragger);
import views$voip$PipContainer from './components/views/voip/PipContainer';
views$voip$PipContainer && (components['views.voip.PipContainer'] = views$voip$PipContainer);
import views$voip$PipView from './components/views/voip/PipView';
views$voip$PipView && (components['views.voip.PipView'] = views$voip$PipView);
